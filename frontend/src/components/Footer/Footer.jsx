            ...
            <MDBFooter color="blue-grey" className="page-footer font-small lighten-5 pt-0">
                ...
                <MDBContainer className="mt-5 mb-4 text-center text-md-left">
                    <MDBRow className="mt-3">
                        ...
                        <MDBCol md="2" lg="2" xl="2" className="mb-4 dark-grey-text">
                            ...
                            <p><Link to="/consumer" className="dark-grey-text">Products </Link></p>
                            <p><Link to="/supplier" className="dark-grey-text">Seller</Link></p>
                        ...
                        <MDBCol md="3" lg="3" xl="4" className="mb-4 dark-grey-text">
                            ...
                            <hr className="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style={{ width: "60px" }} />
                            <p><i className="fa fa-home mr-3" /> Surat,Gujarat</p>
                            <p><i className="fa fa-envelope mr-3" /> shivamvaghani112@gmail.com</p>
                            <p><i className="fa fa-phone mr-3" /> + 91 63538 65983</p>
                            <p><i className="fa fa-print mr-3" /> + 91 63538 66025</p>
                        </MDBCol>
                ...
                <div className="footer-copyright text-center py-3">
                    <MDBContainer fluid>
                        ...
                        Agriculture-portal (Mini Project)
                </MDBContainer>
                </div>
            </MDBFooter>
        </BrowserRouter>
